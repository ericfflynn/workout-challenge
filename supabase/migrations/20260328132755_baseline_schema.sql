-- Baseline migration for the existing Workout Challenge schema.
-- This file captures the current database structure so future schema
-- changes can be added as incremental migrations instead of ad hoc SQL.
